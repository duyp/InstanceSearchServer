% function startConnect(obj,tag,id,datasetDir,datasetFiles,dict,inv,dict_structure,pparams)
%     while 1
%         fprintf('\tConnecting...\n');
%         try
%             %tic;
...
%         %try
%             if strcmp(tag,'query')
%                 result = clientQuery(queryContent,dict,inv,dict_structure,pparams,datasetDir,datasetFiles,18);
